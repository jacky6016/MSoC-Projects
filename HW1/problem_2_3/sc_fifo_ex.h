...
SC_MODULE(sc_fifo_ex) {
	...
	sc_out <double> d_in;
	sc_fifo<double> D_1_2;
	sc_fifo<double> D_2_3;
	sc_fifo<double> R_1_2;
	sc_fifo<double> R_2_3;
	...
	// Processes
	void sc_fifo_ex_thread1(void);
	void sc_fifo_ex_thread2(void);
	void sc_fifo_ex_thread3(void);
};
